...
- **Sonuç:** Canlı — `lib/aps.ts`, `lib/parser/aps-extract.ts`, migration `20260720093000` (runs.aps). Sınır: property koleksiyonu >100MB ise dürüst hata (Vercel bellek; ENQ-223 boyutundaki 285k-objeli modeller için sayfalama gelecek işi).
