...
## Kurulum (5 dakika)
1. **Supabase** → yeni proje aç → SQL Editor'de önce `supabase/migration.sql`'i, sonra `supabase/migrations/` dosyalarını tarih sırasıyla çalıştır → Storage'da **private** `models` bucket'ı oluştur.
